...
import pickle
os.chdir('/media/ramius/New Volume/Work/Jigsaw Academy/Corporate Trainings/Bocconi/Batch 3/Online Sessions/DRT/DRT')
with open('MI_Pkl') as f:
    mi=pickle.load(f)
print mi[:10].sort_values()
```
...
```{r,eval=T, echo=FALSE,fig.align='default',fig.height=5,fig.width=5}
y=rep(5,10)
x=seq(1,10)
